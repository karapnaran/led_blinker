...
#
# esim.tcl: Tcl script for re-creating project 'led_blinker'
#
# Generated by Vivado on Wed Sep 04 21:47:58 +04 2024
...
#
#    "/home/amd/led_blinker/led_blinker.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci"
#    "/home/amd/led_blinker/led_blinker.srcs/sources_1/new/top.v"
#    "/home/amd/led_blinker/led_blinker.srcs/constrs_1/new/top.xdc"
#    "/home/amd/led_blinker/led_blinker.srcs/sim_1/new/tb_top.v"
#    "/home/amd/led_blinker/led_blinker.srcs/utils_1/imports/synth_1/top.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/led_blinker/led_blinker.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci"]"\
 "[file normalize "$origin_dir/led_blinker/led_blinker.srcs/sources_1/new/top.v"]"\
 "[file normalize "$origin_dir/led_blinker/led_blinker.srcs/constrs_1/new/top.xdc"]"\
 "[file normalize "$origin_dir/led_blinker/led_blinker.srcs/sim_1/new/tb_top.v"]"\
 "[file normalize "$origin_dir/led_blinker/led_blinker.srcs/utils_1/imports/synth_1/top.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "led_blinker"
...
set orig_proj_dir "[file normalize "$origin_dir/led_blinker"]"
...
set file "[file normalize "$origin_dir/led_blinker/led_blinker.srcs/constrs_1/new/top.xdc"]"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu7ev-ffvc1156-2-e -flow {Vivado Synthesis 2023} -strategy "Flow_PerfOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/led_blinker.srcs/utils_1/imports/synth_1/top.dcp" -objects $obj
...
if {[string equal [get_runs -quiet synth_1_copy_1] ""]} {
    create_run -name synth_1_copy_1 -part xczu7ev-ffvc1156-2-e -flow {Vivado Synthesis 2023} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/led_blinker.srcs/utils_1/imports/synth_1/top.dcp" -objects $obj
set_property -name "auto_incremental_checkpoint" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/led_blinker.srcs/utils_1/imports/synth_1/synth_1_copy_1" -objects $obj
